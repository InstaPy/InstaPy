...
try:
    ...
    session.follow_likers(['julsoeultra', 'northcoastultra', '9000running', 'goldbearrunners', 'lifeofsportdk', 'claushechmann'], photos_grab_amount=5, follow_likers_per_photo=10, randomize=True,
                          sleep_delay=6, interact=True)

    session.follow_user_followers(['julsoeultra', 'northcoastultra', '9000running', 'goldbearrunners', 'lifeofsportdk', 'claushechmann'], amount=20, randomize=True, sleep_delay=15, interact=True)
