...
def follow_user(browser, track, login, user_name, button, blacklist, source, logger, logfolder):
    ...
    # Populate logs table
    log_table_activity(login, 'Followed', user_name, logger,
        logfolder, logtime, source)
