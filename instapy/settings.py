...
class Settings:
    ...
    # This is where currently the pods server is hosted(account owned by github user: ishandutta2007)
    pods_server_endpoint = 'https://us-central1-instapypods.cloudfunctions.net'
