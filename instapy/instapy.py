...
class InstaPy:
    ...
    def __init__(self,
        ...
        workspace = cli_args.workspace or workspace

        # set workspace folder at desired location (default is at home folder)
        if workspace:
        ...
        if self.proxy.address and self.proxy.port:
    ...
    def set_selenium_local_session(self):
        self.browser, err_msg = set_selenium_local_session(self.proxy,
