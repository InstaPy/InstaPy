...
class InstaPy:
    ...
    def set_smart_location_hashtags(self, locations, radius=10, limit=3, log_tags=True):
        ...
        if log_tags is True:
            self.logger.info(
                u"[smart location hashtag generated: {}]\n".format(
                    self.smart_location_hashtags
                )
            )
    ...
    def clarifai_check_img_for(
        self, tags=None, tags_skip=None, comment=False, comments=None
    ):
    ...
    def set_delimit_liking(self, enabled=None, max=None, min=None):
    ...
    def set_delimit_commenting(
        self, enabled=False, max=None, min=None, comments_mandatory_words=[]
    ):
    ...
    def interact_by_users_tagged_posts(
        self, usernames, amount=10, randomize=False, media=None
    ):
    ...
    def remove_follow_requests(self, amount=200, sleep_delay=600):
    ...
    def grab_followers(
        self, username=None, amount=None, live_match=False, store_locally=True
    ):
        """
    ...
    def pick_mutual_following(
        self, username=None, live_match=False, store_locally=True
    ):
        """
    ...
    def interact_by_URL(self, urls=[], randomize=False, interact=False):
    ...
    def set_do_reply_to_comments(self, enabled=False, percentage=0):
    ...
    def set_comment_replies(self, replies=[], media=None):
    ...
    def set_use_yandex(
        self, enabled=False, API_key=None, match_language=False, language_code="en"
    ):
    ...
    def accept_follow_requests(self, amount=100, sleep_delay=1):
    ...
    def story_by_tags(self, tags: list = None):
        ...
        if tags is None:
            ...
            for index, tag in enumerate(tags):
                ...
                try:
                    watch_story(self.browser, tag, self.logger, "tag")
                except NoSuchElementException:
