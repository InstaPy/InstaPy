...
skip_friends_interaction = os.environ['SKIP_FRIENDS_INTERACTION']
skip_hashtags_interaction = os.environ['SKIP_HASHTAGS_INTERACTION']
skip_locations_interaction = os.environ['SKIP_LOCATIONS_INTERACTION']
skip_follow_unfollow = os.environ['SKIP_FOLLOW_UNFOLLOW']
...
# - likes
if skip_friends_interaction == "yes":
...
if skip_hashtags_interaction == "yes":
